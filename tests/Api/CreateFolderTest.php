...
class CreateFolderTest extends TestCase
{
    ...
    public function testCreateFolderSuccess()
    {
        ...
        $this->post('/api/v1/file/create/folder', $postData, $headers)->seeStatusCode(200)->seeJsonContains([
    ...
    public function testCreateFolderFailed()
    {
        ...
        $this->post('/api/v1/file/create/folder', $postData, $headers)->seeStatusCode(403)->seeJsonContains([
